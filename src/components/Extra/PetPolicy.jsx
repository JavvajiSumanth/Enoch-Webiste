...
const PetPolicy = () => {
  return (
    <div>
      <MiniHeader heading={"What We Do"} subHeading={"Mini Header"} />

      <div className="min-h-screen max-w-screen-xl px-4 py-8  md:p-10  mx-auto">
        <h1 className="font-primary tracking-wide text-5xl text-[#5a150a] font-medium mt-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3">
          <div className="col-span-2 self-center">
            <p className="text-lg my-4">
              Many of our homes are pet friendly and will accept a maximum of 2
              pets. If you apply for or reside in one of our homes and wish to
              have a pet, you will need to complete an online pet profile and
              pay a non-refundable pet application fee of $20 for the 1st pet
              and $15 for the 2nd pet. To start this profile please
            </p>
          </div>
          <img
            src="https://cdn.pixabay.com/photo/2017/08/07/18/57/dog-2606759_960_720.jpg"
            alt=""
            className="my-4 h-full max-h-60 mx-auto"
          />
        </div>
        <p className="text-lg my-4">
        ...
        <h1 className="font-primary tracking-wide text-2xl font-semibold  text-[#5a150a] mt-6">
