    ...
    <div>
      ...
      <div className="min-h-screen max-w-screen-xl px-4 py-8  md:p-10  mx-auto">
        ...
        <p className="text-lg my-4">
          ...
          of your property while avoiding the potential pitfalls of a Fair
          Housing lawsuit. The cherry on top for the buy and hold investor is
          finding a tenant that wants to stay for a very long time.
        </p>
        <p className="text-lg my-4">
        ...
        <p className="text-lg my-4">
          ...
          irresponsible spouse but they were the main source of income in the
        ...
        <p className="text-lg my-4">
          In the words of Ronald Reagan you need to “trust but verify.” Mesa
