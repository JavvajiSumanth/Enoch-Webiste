  ...
  return (
    <div>
      ...
      <div className="min-h-screen max-w-screen-xl px-4 py-8  md:p-10  mx-auto">
        ...
        <h1 className="tracking-wide text-xl font-semibold  my-6">
        ...
        <p className="text-lg my-4">
          At Mesa Properties, we have developed a standard rent ready inspection
          report that all of our property managers use to inspect the above list
          of items and much more. If you are interested in getting a copy,
          contact one of our property managers today or click here to request
          one.
        </p>
      </div>
      <Footer />
