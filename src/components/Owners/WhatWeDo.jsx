  ...
  return (
    <div>
      ...
      <div className="min-h-screen max-w-screen-xl px-4 py-8  md:p-10  mx-auto">
        ...
        <ul className="my-3 space-y-1 text-lg">
        ...
        <h1 className="font-primary tracking-wide text-2xl text-[#5a150a] font-semibold mt-8">
        ...
        <p className="text-lg ">
          Let’s dive a little bit deeper into the exact process that Mesa
