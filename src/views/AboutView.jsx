    ...
    <div>
      ...
      <div className="p-10  max-w-screen-lg mx-auto text-center tracking-wide">
        ...
        <p className="font-primary my-10  text-secondary leading-6 tracking-widest">
          Established in 2009, ENCOH Management is full-service residential and
          commercial property management company servicing Southern California
          with an unwavering dedication toward the optimization of each property
          under management. With offices in both Long Beach and and North East
          Los Angeles, ENCOH Management is able to meticulously manage client’s
          investments thoroughout Southern California ensuring each is operating
          at its highest and best use.
        </p>

        <p className="font-primary my-10  text-secondary leading-6 tracking-widest">
          Diversifying further, ENCOH Management’s multidisciplinary team is
